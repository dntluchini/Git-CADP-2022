...
procedure Maximo (ve : VectorEnt; dimL : integer; var maxNum , maxPos : integer);
var
 i : integer;
begin
 for i := 1 to dimL do 
...
procedure Minimo (ve : VectorEnt; dimL : integer ; var minNum , minPos : integer);
var
 i : integer;
begin
 for i := 1 to dimL do 
...
var
 vector : VectorEnt;
 dimL,min,max,i,posMax,posMin : integer;
begin
 min := 9999; max := -9999; 
 dimL := 0;
